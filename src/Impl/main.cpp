...
int main(int, char**){
   ...
   // Application Setup
    app = ApplicationState((int)(1920*2.0f),(int)(1080*2.0f));
    ...
    displayerManager.AddRenderWindow(new RenderContextDisplay(renderContextDisplay));
    ...
    while(!glfwWindowShouldClose(window)){
        ...
        static bool showWireFrameShaded = false;
