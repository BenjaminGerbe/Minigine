...
void RenderContextShaded::SetUp(glm::mat4* _MVP,int width,int height ){
...
void RenderContextWireFrame::SetUp(glm::mat4* _MVP,int width,int height ){
...
void RenderContextShadedWireFrame::SetUp(glm::mat4* _MVP,int width,int height ){
    this->width = width;
    this->height = height;
...
int RenderContextShaded::GetHeight(){
    return height;
}

int RenderContextShaded::GetWidth(){
    return width;
}

int RenderContextShadedWireFrame::GetHeight(){
    return height;
}

int RenderContextShadedWireFrame::GetWidth(){
    return width;
}

int RenderContextWireFrame::GetHeight(){
    return height;
}

int RenderContextWireFrame::GetWidth(){
    return width;
}